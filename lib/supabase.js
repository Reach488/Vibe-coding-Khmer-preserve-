...
// bundle and are meant to be public. The publishable key is not a secret — it
// only ever grants what row-level security allows. The keys themselves live
// in .env.local and in the Vercel environment variables, never in this file.
